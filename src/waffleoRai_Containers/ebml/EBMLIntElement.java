...
public class EBMLIntElement extends EBMLElement {
	
	//Up to 31 bits unsigned or 32 bits signed
	
	private boolean isSigned = false;
	private int iValue;
	
	public EBMLIntElement(int elementId, int value) {
		this(elementId, value, false);
	}
	
	public EBMLIntElement(int elementId, int value, boolean signed) {
		super.UID = elementId;
		iValue = value;
		isSigned = signed;
	}
	...
	public void setValue(int val) {iValue = val;}
